...
::erase can:
-delete a single element from a vector: vectorInts.erase(vectorInts.begin()+4);
-delete a range of elements form a vector: vectorInts.erase(vectorInts.begin()+1, vectorInts.begin()+3);
*/
#include <iostream>
#include <vector>
