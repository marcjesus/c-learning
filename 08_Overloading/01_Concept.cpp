/*
Function Overloading will allow us to use the same function name for different
functions. As long as the argument list is different, the compiler will be able to choose
the correct definition.
If you would like to learn more about Overloading, you will find this tutorial helpful.
